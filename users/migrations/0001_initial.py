    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pan_number', models.CharField(blank=True, max_length=9)),
                ('contact', models.CharField(blank=True, max_length=10)),
                ('sellerImgUrl', models.URLField(blank=True, default='https://res.cloudinary.com/djzfsffst/image/upload/v1707144245/user-default_macios.png')),
